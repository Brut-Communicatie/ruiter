        ...
        <div class="content__right">
            ...
            <div class="content__right--share">
                ...
                <div class="content__right--share-buttons">
                    <a href="whatsapp://send?text=Dit is echt iets voor jou maat! Bekijk deze vacature!"><img src="<?php echo get_template_directory_uri();?>/content/img/whatsapp-brands.svg" alt="Whatsapp" width="20px"></a>
                    <a href="mailto:?subject=Dit is echt iets voor jou maat! Bekijk deze vacature!&amp;body=Bekijk de vacature voor dakkapel monteur! http://www.website.com."><img src="<?php echo get_template_directory_uri();?>/content/img/envelope-solid.svg" alt="Mail" width="20px"></a>
                </div>
            </div>
        </div>
    </div>
